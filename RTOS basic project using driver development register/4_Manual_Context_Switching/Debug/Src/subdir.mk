...
Src/timebase.o: ../Src/timebase.c Src/subdir.mk
	arm-none-eabi-gcc "$<" -mcpu=cortex-m4 -std=gnu11 -g3 -DSTM32F411xE -c -I../Inc -I"C:/Users/Gaming Laptop RTX/Documents/BuildYourOwnRTOS/GCC_STM32CubeIDE/4_Manual_Context_Switching/chip_headers/CMSIS/Include" -I"C:/Users/Gaming Laptop RTX/Documents/BuildYourOwnRTOS/GCC_STM32CubeIDE/4_Manual_Context_Switching/chip_headers/CMSIS/Device/ST/STM32F4xx/Include" -O0 -ffunction-sections -fdata-sections -Wall -fstack-usage -MMD -MP -MF"Src/timebase.d" -MT"$@" --specs=nano.specs -mfpu=fpv4-sp-d16 -mfloat-abi=hard -mthumb -o "$@"
